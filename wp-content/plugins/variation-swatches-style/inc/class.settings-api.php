            ...
            <?php foreach ( $this->settings_sections as $form ) { ?>
                <div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
                	...
                	<?php if ( !empty( $form["id"] ) && $form["id"] == 'atawc_tutorials' ) :?>
						...
						<?php require( plugin_dir_path( __FILE__ ).'/tutorials.php'); ?>
                    <?php elseif($form["id"] == 'atawc_color' ) : ?>   
                     <h2><?php echo esc_html__('Color Swatches Settings','smart-variation-swatches');?></h2>
